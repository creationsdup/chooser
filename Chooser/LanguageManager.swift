...
private enum Translations {
    ...
    static let table: [String: [String: String]] = [
        ...
        "style.classic":                   ["fr": "Classique",          "en": "Classic"],
        "style.classic.desc":              ["fr": "Interface iOS épurée et cohérente",
                                            "en": "Clean, coherent iOS interface"],
        ...
        "style.minimal":                   ["fr": "Minimal",            "en": "Minimal"],
        "style.minimal.desc":              ["fr": "Fond blanc, espace maximal, clarté totale",
                                            "en": "White background, maximum space, total clarity"],
        "style.midnight":                  ["fr": "Minuit",             "en": "Midnight"],
        "style.midnight.desc":             ["fr": "Fond sombre immersif avec accents lumineux",
                                            "en": "Immersive dark background with glowing accents"],
