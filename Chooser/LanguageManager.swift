...
private enum Translations {
    ...
    static let table: [String: [String: String]] = [
        ...
        "lists.empty.body":      ["fr": "Crée ta première liste et utilise-la dans tous les modes de tirage.",
                                  "en": "Create your first list and use it across all picker modes."],
        ...
        "lists.rename":          ["fr": "Renommer",             "en": "Rename"],
        "lists.rename.title":    ["fr": "Renommer la liste",    "en": "Rename list"],
        "lists.use":             ["fr": "Utiliser cette liste", "en": "Use this list"],
        "emoji.picker.title":    ["fr": "Choisir un émoji",    "en": "Choose an emoji"],
        "emoji.picker.remove":   ["fr": "Retirer",             "en": "Remove"],
        "emoji.cat.popular":     ["fr": "Populaires",          "en": "Popular"],
        "emoji.cat.media":       ["fr": "Médias",              "en": "Media"],
        "emoji.cat.food":        ["fr": "Nourriture",          "en": "Food"],
        "emoji.cat.sport":       ["fr": "Sport",               "en": "Sport"],
        "emoji.cat.work":        ["fr": "Travail",             "en": "Work"],
        "emoji.cat.nature":      ["fr": "Nature",              "en": "Nature"],
        "emoji.cat.animals":     ["fr": "Animaux",             "en": "Animals"],

        // ── List detail ───────────────────────────────────────────────────
        "detail.addPlaceholder": ["fr": "Ajouter un élément…", "en": "Add an item…"],
        "detail.emptyTitle":     ["fr": "Rien ici pour l'instant", "en": "Nothing here yet"],
        "detail.emptyBody":      ["fr": "Ajoute ton premier élément avec le champ ci-dessous",
                                  "en": "Add your first item with the field below"],
        ...
        "settings.danger":        ["fr": "Gestion des données",   "en": "Data Management"],
        "settings.reset":         ["fr": "Réinitialiser les données", "en": "Reset all data"],
        ...
        "source.selector.title":    ["fr": "Source des items", "en": "Item source"],
        "source.selector.editEntries": ["fr": "Modifier les éléments", "en": "Edit entries"],
